...
import AnnouncementsCSS from "./Announcements.module.css";

const Announcements = () => {
  return (
    <>
      <Container fluid className={AnnouncementsCSS.section}>
        <div className={AnnouncementsCSS["section-header"]}>
          <h3>Announcements</h3>
          <a href="#" className={AnnouncementsCSS["read-more"]}>
            <span>Read more</span>
